...
type ServiceDetailText = Omit<ServiceDetail, "image" | "cardImage">;
...
const serviceDetailsText = {
  ...
  "swimming-pool-safety-nets": {
    ...
    shortBenefit: "Custom netting for pool edges, decks, and shared amenity areas.",
  ...
  "cloth-hanger-installation": {
    ...
    shortBenefit: "Ceiling and balcony drying systems made for daily utility use.",
...
} satisfies Record<ServiceSlug, ServiceDetailText>;

export const serviceDetailsBySlug = Object.fromEntries(
  Object.entries(serviceDetailsText).map(([slug, detail]) => {
